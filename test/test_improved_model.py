...
from improved_model import myIFCNN
...
CKPT_PATH = "snapshots/IFCNN-MAX-improved_model_stage2_adam_ep24.pth"
...
OUT_DIR = os.path.join(SCRIPT_DIR, "results_test", "results_improved")
...
def run_test():
    ...
    print("\n=== TEST METRICS vs Ground Truth (IMPROVED) ===")
    print(summary)
